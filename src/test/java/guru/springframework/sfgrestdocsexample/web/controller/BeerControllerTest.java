...
@AutoConfigureRestDocs(uriScheme = "https",
        uriHost = "dev.springframework.sfgrestdocsexample.guru",
        uriPort = 80)
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}" , UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer-get",
                        ...
                        requestParameters(
                               parameterWithName("iscold").description("Is beer coldquery param")),
                        responseFields(
                                ...
                                fieldWithPath( "beerStyle").description("beerStyle"),
